...
def main():
    ...
    each_book_rating = pd.pivot_table(
        books_data, index='user_id', 
        values='rating', columns='title', fill_value=0)
    print(books_data)
    ...
    book_recommendations = get_recommendation(my_fav_books, book_corr, book_titles)
    print(len(book_recommendations))
...
def get_recommendation(books_list, book_corr, book_titles):
    print(book_corr)
